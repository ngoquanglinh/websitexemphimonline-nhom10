...
?>
	<div class="container-fluid">
		<div class="container">
			<div class="row movie">
				<div class="cod-md-12 col-sm-12 col-xs-12 youtube">
					<div class="embed-responsive embed-responsive-16by9">
						<iframe class="embed-responsive-item" width="980px" height="500px" src="<?php echo $array_xemtrailer['link_trailer'] ?>" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
						</iframe>
					</div>
				</div>
			</div>
			...
			<div class="row ads1">
				<div class="col-md-12 col-sm-12 col-xs-12 ads1">
					<img src="admin/modules/quanlychitietphim/uploads/ads1.gif">
				</div>
			</div>
		</div>
	</div>
