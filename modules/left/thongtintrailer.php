...
?>
    ...
    <div class="content-left">
        <div class="col-md-8 col-lg-12 col-xs-12 edit-pd">
            <div class="row thongtinfilm">
                <div class="col-md-5 col-lg-12 col-xs-12">
                    <div class="pf-image">
                ...
                <div class="col-md-7 col-lg-12 col-xs-12 profile-film">
                    <h1><?php echo $array_trailer['tenphim_trailer'] ?></h1>
                    <h2><?php echo $array_trailer['tenenglish_trailer'] ?></h2>
                    <ul>
                        <li>
                            <label>Đang phát:<strong> Tập 1 vietsub</strong></label>
                        </li>
                        <li>
                            <label>Sắp chiếu:<strong> Tập 2 vietsub</strong></label>
                        </li>
                        <li>
                            <label>Đạo diễn:<a href=""> ngolinh</a></label>
                        </li>
                        <li>
                            <label>diễn viên:<a href=""> ngolinh</a></label>
                        </li>
                        <li>
                            <label>Thể loại:<a href=""> phim hành động</a></label>
                        </li>
                        <li>
                            <label>Quốc gia:<a href=""> việt nam</a></label>
                        </li>
                        <li>
                            <label>Thời lượng:<a href=""> 10 tập</a></label>
                        </li>
                        <li>
                            <label>Lượt xem:<span> 1000</span></label>
                        </li>
                        <li>
                            <label>Năm xuất bản:<a href=""> 2019</a></label>
                        </li>
                        <li class="fb">
