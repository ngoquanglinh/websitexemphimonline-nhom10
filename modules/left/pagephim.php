    ...
    <div class="content-left">
        <div class="col-md-8 pagect">
            <div class="row caption">
                <div class="col-md-8 col-xs-12 col-sm-12 title-pagephim">
                    <?php 
                    $sqltittle="SELECT * FROM loaiphim WHERE id_loaiphim=$_GET[id_loaiphim]";
                    $querysltittle=mysqli_query($connect,$sqltittle);
                    while($arr=mysqli_fetch_array($querysltittle)){
                     ?>
                     <i class="fa fa-folder-open"></i>
                     <h3><?php echo $arr['tênloai_phim'];?>  localhost</h3>
                     <?php 
                 }
                 ?>
             </div>
        ...
        <div class="row dmm">
            <div class="row thumbnail-thu1">
                ...
                while($array_pagephim=mysqli_fetch_array($query_pagephim)){
                  ?>
                  <div class="col-xs-6 col-md-3 col-sm-6 edit-pd">
